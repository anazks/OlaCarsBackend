...
const ALLOWED_CREATE_FIELDS = ['name', 'code', 'address', 'city', 'state', 'phone', 'email', 'status', 'country', 'countryManager'];
const ALLOWED_UPDATE_FIELDS = ['name', 'address', 'city', 'state', 'phone', 'email', 'status', 'country', 'countryManager'];

...
const ALLOWED_CREATE_FIELDS = ['name', 'code', 'address', 'city', 'state', 'phone', 'email', 'status', 'country', 'countryManager', 'type'];
const ALLOWED_UPDATE_FIELDS = ['name', 'address', 'city', 'state', 'phone', 'email', 'status', 'country', 'countryManager', 'type'];
...
const { getBranchesService, getBranchByIdService, getBranchExtendedDetailsRepo } = require('../Repo/BranchRepo.js');
...
exports.getExtendedDetails = async (id, filters = {}) => {
    return await getBranchExtendedDetailsRepo(id, filters);
};

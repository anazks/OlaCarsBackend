...
const filePath = "C:\\\\Users\\\\anton\\\\OneDrive\\\\Documents\\\\vs coding\\\\OlaCarsBackend\\\\Src\\\\modules\\\\Bill\\\\Service\\\\BillService.js";
const content = fs.readFileSync(filePath, 'utf8');

// We want to find the start of exports.bulkUploadBills
const targetSignature = 'exports.bulkUploadBills = async';
const index = content.indexOf(targetSignature);
if (index === -1) {
    console.error("COULD NOT FIND SIGNATURE!");
    process.exit(1);
}

const headerPart = content.substring(0, index);

const newBulkUpload = `exports.bulkUploadBills = async (rows, actor, userBranchId) => {
...
fs.writeFileSync(filePath, headerPart + newBulkUpload, 'utf8');
console.log("SUCCESSFULLY REWRITTEN BILL SERVICE VIA NODE!");
process.exit(0);
